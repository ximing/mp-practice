export default function obaa(this: any, target: any, arr: any, callback: Function) {
  var _observe = function (this: any, target: any, arr: any, callback: Function) {
